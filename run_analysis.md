...
```
## [1] "C:/Users/Gurdal/Documents/Coursera/Getting and Cleaning Data/project/gurdal"
```
...
Download the file and unzip the file. You need to have (x86) 7-zip software, for reproducibility of the code.  
...
write.table(dtTidy, "DatasetHumanActivityRecognitionUsingSmartphones.txt", row.names = FALSE, quote = FALSE)
```
